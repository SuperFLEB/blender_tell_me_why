...
class AUIList(UIList):
    ...
    bl_label = "Numbers"
    bl_idname = "tell_me_why_UL_a_ui_list"
...
class AnOperatorWithUIList(Operator):
    ...
    bl_idname = "tell_me_why.an_operator_with_uilist"
    ...
    def draw(self, context) -> None:
        ...
        self.layout.template_list("tell_me_why_UL_a_ui_list", "a_list_of_numbers", self, "uilist_items", self,
                                  "active_uilist_index")
    ...
    def execute(self, context) -> Set[str]:
        ...
        bpy.context.window_manager.popup_menu(message, title="Tell Me Why")
        return {'FINISHED'}
