...
class FileTrustSubmenu(Menu):
    ...
    def draw(self, context):
        ...
        trust_explainers = {
            ...
            'SESSION': "The file has been trusted for this session",
        ...
        if trust_all:
            ...
            layout.label(text=trust_explainers.get(trust_reason), icon="INFO")
        else:
        ...
        if is_trusted and trust_reason == "SESSION":
            layout.operator(trust.UntrustSession.bl_idname)
        else:
