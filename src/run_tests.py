...
# e.g.,
#
# blender --factory-startup --background --python 3.2/scripts/addons/tell_me_why/run_tests.py
# or
# blender --factory-startup --background --python 3.2\scripts\addons\tell_me_why\run_tests.py
#
